    ...
    <>
        ...
        <section className="cont_main">
            <div className="top-section">
                <div className="judul">
                    <div className="text-wrapper">Konfirmasi Kargo</div>
            ...
            <div className="base-4">
                <div className="frame-atas">
                    ...
                    <div className="frame-selection">
                        ...
                        <div className="text-wrapper">Kontak Pembeli</div>
                    </div>

                    <div className="frame-selection">
                        <img className="img" alt="Ikon check notyet" src={ikonCheckOngoing} />

                        <div className="text-wrapper-bold">Konfirmasi data</div>
                    </div>
                </div>

                <div className="form-booking">
                    <div className="frame-booking-2">
                        <p className="text-wrapper-18">
                            NOTE: Silahkan periksa kembali detail pesanan kargo anda sebelum menyelesaikan booking pelayaran anda!
                        </p>
                        ...
                        <div className="frame-asal-kargo">
                            <div className="frame-alamat-pick">
                                ...
                                <div className="div-2">
                                <div className="text-wrapper-2">Pembeli anda</div>
                                ...
                                <div className="div-2">
                                <div className="text-wrapper-2">Kontak pembeli anda</div>
                        ...
                        <div className="frame-asal-kargo">
                            <div className="frame-alamat-pick">
                                ...
                                <div className="div">
                                <div className="text-wrapper-2">Komoditas</div>

                                <div className="frame-detail-kargo">
                                    <div className="text-wrapper-3-kargo">Komoditas saya</div>
                                </div>
                                </div>

                                <div className="frame-tanggal">
                                <p className="text-wrapper">Apa saja detail dari kargo anda?</p>

                                <div className="div">
                                    <div className="text-wrapper-2">Deskripsi kargo</div>

                                    <div className="frame-detail-kargo">
                                    <div className="text-wrapper-3-kargo">Kargo saya</div>
                                    </div>
                                </div>
                                ...
                                <div className="frame-alamat-negara">
                                    ...
                                    <div className="frame-detail-kargo">
                                        <div className="text-wrapper-3-kargo">Jumlah</div>
                                    </div>
                                    </div>

                                    <div className="frame-alamat">
                                    <div className="text-wrapper-2">Nomor (Opsional)</div>

                                    <div className="frame-detail-kargo">
                                        <div className="text-wrapper-3-kargo">Nomor</div>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div className="frame-alamat-negara">
                                    <div className="frame-alamat">
                                    <div className="text-wrapper-2">Kota</div>

                                    <div className="frame-detail-kargo">
                                        <div className="text-wrapper-3-kargo">Kota saya</div>
                                    </div>
                                    </div>

                                    <div className="frame-alamat">
                                    <div className="text-wrapper-2">Kode Pos</div>

                                    <div className="frame-detail-kargo">
                                        <div className="text-wrapper-3-kargo">Gudang saya</div>
                                    </div>
                                    </div>
                                </div>

                                <div className="text-wrapper-4">Berat kontainer</div>

                                <div className="div">
                                    <div className="text-wrapper-2">Total massa</div>

                                    <div className="frame-detail-kargo">
                                    <div className="text-wrapper-3-kargo">Massa</div>
                                    </div>
                                </div>
                        ...
                        <div className="frame-asal-kargo">
                            ...
                            <div className="div">
                                ...
                                <div className="frame-tombol">
                                    <Link to="/booking-4" className="tombol link-universal">
                                        <div className="text-wrapper-5">Kembali</div>
                                        {/* <img className="img-blog" alt="Arrow right" src={ArrowRight2} /> */}
                                    </Link>
                            

                                    <Link to="/booking-6" className="simpan-lanjutkan-wrapper link-universal">
                                        <div className="simpan-lanjutkan">Simpan</div>
                                        {/* <img className="img-blog" alt="Arrow right" src={ArrowRight2} /> */}
                                    </Link>
                                    ...
                                    <div className="text-wrapper-4">Simpan</div>
                                    </div> */}
                                </div>
                            </div>
                        </div>
...
export default BookingKonfirmasi