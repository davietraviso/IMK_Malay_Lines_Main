            ...
            <div className="base-4">
                <div className="frame-atas">
                    ...
                    <div className="frame-selection">
                        ...
                        <div className="text-wrapper-bold">Detail Kargo</div>
                    </div>

                    <div className="frame-selection-2">
                        <img className="img" alt="Ikon check notyet" src={ikonCheckNotyet} />

                        <div className="text-wrapper-2">Kontak Pembeli</div>
                    </div>
                    ...
                    <div className="frame-booking-1">
                        ...
                        <div className="frame-asal-kargo">
                            <div className="frame-alamat-pick">
                                <div className="text-wrapper">Apa yang anda kirim?</div>
                                ...
                                <div className="frame-detail-kargo">
                                    ...
                                    <input
                                        type="text"
                                        className="text-wrapper-3-kargo"
                                        placeholder="Komoditas saya"
                                        // value={namaNegara}
                                ...
                                <div className="frame-tombol">
                                    ...
                                    <Link to="/booking-4" className="simpan-lanjutkan-wrapper link-universal">
                        ...
                        <div className="frame-pilihan">
                            ...
                            <div className="frame-pengingat">
                                ...
                                <div className="text-wrapper-3-kargo">Lihat jadwal lengkap</div>
                                </div>
                            </div>
